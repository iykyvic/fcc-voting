...
options.get('/view', _options.findOptions).post('/:id/updatestat', _options.updatePollOptionStat).use(_auth.verifyToken)
...
}), _options.createOption).post('/:id/update', _options.updatePollOption).delete('/:id/delete/', _options.deletePollOption);
