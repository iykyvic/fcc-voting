...
var updatePollOptionStat = exports.updatePollOptionStat = function () {
  var _ref4 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(req, res) {
    var body, author, id, _id, authorId, date, title, optionId, rest, option, savedOption;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            body = req.body, author = req.body.author, id = req.params.id, _id = req.decoded._id;
            authorId = body.author, date = body.date, title = body.title, optionId = body._id, rest = (0, _objectWithoutProperties3.default)(body, ['author', 'date', 'title', '_id']);
            _context4.next = 5;
            return _index.Option.findById(id);
